 ...
 * 思路很像RequestQueue中的.先查询了缓存,然后再下载,然后保存正在下载的队列.防止相同的任务在下载.
 * 这个类不要和RequestQueue中的信息混乱了.
 * <p/>
...
public class ImageLoader {
     ...
     * 图片的缓存,其实可以用两级缓存的呢...可以模仿xUtils写,而且网络请求已经写好了.还需要什么呢.
     */
     ...
     * @param imageCache The cache to use as an L1 cache.我觉得ImageCache内部可以 L1 + L2 Cache
     */
